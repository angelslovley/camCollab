...
projectSchema.methods.modulesJSON = function () {
...
projectSchema.methods.getVideos = function () {
...
projectSchema.statics.getCoursesWithPrivilege = async function (userId) {
...
projectSchema.methods.enroll = function (userId, role) {
...
projectSchema.methods.unEnroll = function (userId) {
...
projectSchema.methods.getInstructors = function () {
  return this.enrollments.filter(
    (enrollment) => enrollment.enrolledAs === 'instructor'
  )
}

projectSchema.statics.getDeadLines = async function (courseId) {
...
projectSchema.statics.formatCalendar = function (deadlines) {
  const result = {}
