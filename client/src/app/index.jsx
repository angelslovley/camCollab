...
import TopicsDiscussionFeed from '../views/topicdiscussions'
import AnnouncementsFeed from '../views/announcements'
import Discussions from '../views/forums'
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        <Content style={{ padding: '20px 32px', height: '100%' }}>
            ...
            <Route exact path="/app/topics" component={Discussions} />
            ...
            <Route
              path="/app/topics/:topicId/discussions"
              render={(props) => (
                <TopicsDiscussionFeed
                  {...props}
                  courseId={props.match.params.topicId}
                />
              )}
            />
